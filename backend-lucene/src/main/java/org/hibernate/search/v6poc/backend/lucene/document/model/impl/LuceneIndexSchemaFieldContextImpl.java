 ...
 */
public class LuceneIndexSchemaFieldContextImpl implements IndexSchemaFieldContext {

	private final String relativeName;

	private IndexSchemaFieldTypedContext<?> delegate;
	...
	private <T extends IndexSchemaFieldTypedContext<?>> T setDelegate(T context) {
		if ( delegate != null ) {
