...
public abstract class AbstractLuceneTypedFieldModelContext<T>
	...
	@Override
	public void contribute(LuceneFieldModelCollector collector) {
		contribute( accessor, collector );
	}

	protected abstract void contribute(DeferredInitializationIndexFieldAccessor<T> reference,
			LuceneFieldModelCollector collector);
